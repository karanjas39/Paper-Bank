...
function HeroSection() {
  ...
  return (
    <div className="w-full px-7 h-screen dark:bg-background bg-background  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex md:items-center justify-center items-start">
